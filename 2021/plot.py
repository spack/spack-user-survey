...
heat_map(
    ...
    feature_cols, ratings, weights, xlabels, False, feature_cmap, sectors,
)

heat_map(
    "Average feature importance by job type",
    "features_by_job",
    feature_cols, ratings, weights, xlabels, False, feature_cmap, roles,
)
...
heat_map(
    ...
    feature_cols, ratings, weights, xlabels, True, quality_cmap, sectors,
)

heat_map(
    "Average quality rating by job type",
    "quality_by_job",
    feature_cols, ratings, weights, xlabels, True, quality_cmap, roles
)
